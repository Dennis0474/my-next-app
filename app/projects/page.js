...
export default function Projects() {
  return (
    ...
    <h1 className="text-4xl font-bold text-blue-400 mb-8">My Projects</h1>
    <div className="grid grid-cols-1 gap-6">
      {projects.map(project => (
       <div key={project.id} className="bg-gray-800 p-6 rounded-lg">
        ...
        <a href="{project.link}" className="bg-blue-500 px-4 py-2 rounded hover:bg-blue-600" target="_blank">View on GitHub</a>
       </div> 
      ))}
    </div>
    </div>
